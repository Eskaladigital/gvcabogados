/**
 * Redacta o reescribe el contenido HTML (ES) de un artículo del blog.
 * No genera portadas. No toca la versión inglesa (usa translate:blog después).
 *
 * Uso:
 *   npx tsx scripts/redact-blog-article.ts "https://www.gvcabogados.com/es/blog/SLUG"
