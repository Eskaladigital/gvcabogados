...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = content.metaDescriptionEs || content.shortDescriptionEs ||
    `Abogados especialistas en accidentes de tráfico en ${cityName}. Indemnizaciones máximas, baremo de tráfico, defensa de víctimas. Más de 75 años de experiencia. ☎ 968 241 025.`;
