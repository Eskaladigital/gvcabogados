...
export default async function SitemapPage() {
  ...
  // Obtener todos los slugs de servicios desde Supabase
  const serviceSlugs = await getAllServiceContentSlugs();

  const mainPages = [
    { href: '/es', label: 'Inicio', icon: Home },
    { href: '/es/sobre-nosotros', label: 'Sobre Nosotros', icon: Users },
    { href: '/es/servicios', label: 'Áreas de Práctica', icon: Scale },
    { href: '/es/equipo', label: 'Equipo', icon: Users },
    { href: '/es/contacto', label: 'Contacto', icon: Phone },
  ];
          ...
          <div className="container-custom">
            <div className="max-w-3xl">
              ...
              <p className="text-base text-neutral-300 leading-relaxed">
                Explore todas las páginas y servicios legales que ofrecemos en García-Valcárcel & Cáceres Abogados.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-neutral-200">
                ...
                <div className="mt-4 pt-4 border-t border-neutral-200">
                  <p className="text-xs text-neutral-500">
                    Total de páginas de servicios: <strong>{serviceSlugs.length}</strong>
                  </p>
                </div>
              </div>
            </div>
