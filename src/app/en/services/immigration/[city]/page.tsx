...
const SERVICE_NAME_EN = 'Immigration & Residence Permits';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = content.titleEn || `Immigration Lawyers in ${cityName} — GVC Lawyers`;
  const description = content.metaDescriptionEn || content.shortDescriptionEn ||
    `Specialist immigration and residence permit lawyers in ${cityName}. Work permits, family reunification, residency applications. Over 55 years of experience. ☎ 968 241 025.`;
...
const DEFAULT_STATS = [
  ...
  { value: 'Multilingual', label: 'Service in several languages' },
  { value: 'No obligation', label: 'Initial consultation' },
];

const DEFAULT_TIPOS_PERMISO = [
  { titulo: 'Social roots (Arraigo social)', descripcion: 'Residence permit based on social roots after 3 years of continuous stay in Spain with proven social integration.' },
  { titulo: 'Family roots (Arraigo familiar)', descripcion: 'Residence permit for parents of Spanish minors or children of Spanish nationals by origin.' },
  { titulo: 'Employment roots (Arraigo laboral)', descripcion: 'Authorisation for foreign nationals who can prove employment relationships of at least 6 months.' },
  { titulo: 'EU family residence', descripcion: 'Residence card for family members of EU citizens: spouses, descendants and ascendants.' },
  { titulo: 'Family reunification', descripcion: 'Right of legal residents to bring their immediate family: spouse, minor children and dependent ascendants.' },
  { titulo: 'Renewals and extensions', descripcion: 'Full management of residence and work permit renewals, preventing loss of legal status.' },
];

const DEFAULT_DOCUMENTACION = [
  { paso: 1, titulo: 'Valid passport', descripcion: 'Original and full copy of all applicants\' current passports.' },
  { paso: 2, titulo: 'Municipal registration (Empadronamiento)', descripcion: 'Certificate of municipal registration proving the applicant\'s address in the municipality.' },
  { paso: 3, titulo: 'Criminal record certificate', descripcion: 'Criminal record certificate from the country of origin, apostilled or legalised and translated.' },
  { paso: 4, titulo: 'Proof of financial means', descripcion: 'Documentation proving sufficient financial means: payslips, employment contract or tax return.' },
  { paso: 5, titulo: 'Health insurance or health card', descripcion: 'Public or private health insurance covering the applicant during their stay in Spain.' },
];

export default async function ImmigrationLocalPage({ params }: Props) {
  const content = await getServiceContentByServiceAndCity(SERVICE_KEY, params.city);
  if (!content) notFound();
  ...
  const breadcrumbs = [
    ...
    { name: 'Immigration', href: `/en/services/${FOLDER_SLUG_EN}` },
  ...
  return (
    <>
      ...
      <ServiceSchema
        name={content.titleEn || `Immigration Lawyers in ${cityName}`}
        ...
        <section className="bg-[#1a1a1a] relative overflow-hidden min-h-[75vh] md:min-h-[80vh] flex flex-col">
          <div className="absolute inset-0 opacity-25 z-0">
            <Image
              ...
              alt={`Immigration lawyers in ${cityName}`}
              fill
          ...
          <div className="container-custom relative z-[2] flex-1 flex items-center py-14 md:py-20">
            <div className="max-w-[720px] w-full">
              ...
              <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-bold text-white leading-[1.15] mb-5 md:mb-6">
                Immigration &amp;{' '}
                <em className="italic text-brand-gold font-normal">residence permit lawyers</em>{' '}
                in {cityName}
              </h1>

              <p className="text-base md:text-lg text-neutral-300 leading-relaxed mb-8 md:mb-10 max-w-[580px]">
                {content.shortDescriptionEn || `Specialists in residence permits, social roots, family reunification and immigration procedures in ${cityName}.`}
              </p>
          ...
          <div className="container-custom max-w-6xl">
            <div className="reveal">
              ...
              <h2 className="section-title mb-6">
                {content.titleEn || `Immigration lawyers in ${cityName}`}
              </h2>
              ...
              <div className="relative float-right ml-8 mb-6 w-full sm:w-[320px] lg:w-[380px]">
                <div className="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-xl">
                  <Image
                    src="/images/slides/garcia_valcarcel_caceres_abogados_slide_home_v2.webp"
                    alt={`Immigration lawyers ${cityName}`}
                    fill
                    className="object-cover"
          ...
          <section className="py-16 md:py-24 bg-neutral-50">
            <div className="container-custom max-w-6xl">
              <div className="reveal text-center mb-14">
                ...
                <h2 className="section-title mb-4">Types of residence permit in {cityName}</h2>
              </div>
          ...
          <section className="py-16 md:py-24 bg-neutral-50">
            <div className="container-custom max-w-6xl">
              <div className="reveal text-center mb-14">
                ...
                <h2 className="section-title mb-4">Immigration in {cityName}: what you need to know</h2>
              </div>
            ...
            <div className="reveal flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              <div className="flex-1 text-center md:text-left">
                <h3 className="font-serif text-xl md:text-2xl font-semibold text-white mb-3">
                  Immigration Office &amp; Government Delegation in {cityName}
                </h3>
                <p className="text-sm text-neutral-300 leading-relaxed max-w-2xl">
                  Residence permit applications are processed through the <strong className="text-white">Immigration Office (Oficina de Extranjería)</strong> or
                  the relevant Government Delegation. Our lawyers are familiar with the specific procedures
                  in {cityName} and will guide you through every step — from filing applications to appeals.
                </p>
              </div>
              <div className="shrink-0">
                <Link href="/en/contact" className="btn-primary whitespace-nowrap">
                  Enquire about procedures →
                </Link>
              </div>
            </div>
          </div>
          ...
          <section className="py-16 md:py-24 bg-neutral-50">
            <div className="container-custom max-w-6xl">
              <div className="reveal text-center mb-14">
                <div className="flex items-center gap-3 justify-center mb-4">
                  <span className="w-9 h-0.5 bg-brand-brown" />
                  <span className="text-[0.6rem] font-semibold text-brand-brown tracking-[0.2em] uppercase">Requirements</span>
                  <span className="w-9 h-0.5 bg-brand-brown" />
                </div>
                <h2 className="section-title mb-4">Documentation required for your application in {cityName}</h2>
                <p className="text-sm text-neutral-400 max-w-2xl mx-auto">
                  These are the most common documents. Requirements may vary depending on the permit type. We will advise you on your specific case.
                </p>
              </div>
                ...
                {documentacion.map((doc, i) => (
                  <div key={i} className="reveal group bg-white p-7 md:p-8 rounded-2xl border border-neutral-100 hover:border-brand-brown/30 hover:shadow-lg transition-all">
                    <div className="flex items-start gap-4 mb-3">
                      ...
                      <div>
                        <div className="text-[0.6rem] text-brand-brown font-semibold uppercase tracking-wider mb-1">Step {doc.paso}</div>
            ...
            <div className="container-custom max-w-6xl">
              <div className="reveal grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16">
                <div className="lg:col-span-3">
                  ...
                  <h2 className="section-title mb-8">How we handle your application in {cityName}</h2>
                ...
                <div className="lg:col-span-2">
                  <div className="bg-brand-brown-hover text-white p-8 md:p-10 rounded-2xl sticky top-24">
                    ...
                    <h3 className="font-serif text-xl font-semibold mb-4">
                      Need a residence permit in {cityName}?
                    </h3>
                    ...
                    <ul className="space-y-3 mb-8">
                      {[
                        'Personalised review of your file',
          ...
          <section className="py-16 md:py-24 bg-white">
            <div className="container-custom max-w-4xl">
              <div className="reveal text-center mb-12">
                ...
                <h2 className="section-title mb-4">Frequently asked questions about immigration in {cityName}</h2>
              </div>
          ...
          <div className="container-custom max-w-4xl">
            <div className="reveal text-center">
              <p className="text-sm text-neutral-400 mb-4">
                Also visit our general immigration page for information on types of permits, documentation requirements and the full legal process.
              </p>
              <Link
              ...
              >
                View the general Immigration page <ArrowRight size={16} />
              </Link>
            </div>
          </div>
        </section>
          ...
          <div className="container-custom max-w-4xl relative z-10">
            <div className="reveal text-center">
              ...
              <h2 className="section-title-white mb-6">
                Immigration lawyers in {cityName}
              </h2>
