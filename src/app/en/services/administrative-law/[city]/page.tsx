...
const SERVICE_NAME_EN = 'Government Liability';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = content.titleEn || `Government Liability Lawyers in ${cityName} — GVC Lawyers`;
  const description = content.metaDescriptionEn || content.shortDescriptionEn ||
    `Specialist government liability lawyers in ${cityName}. Claims against public authorities for negligence and maladministration. Over 55 years of experience. ☎ 968 241 025.`;
...
const DEFAULT_STATS = [
  ...
  { value: 'Law 40/2015', label: 'LRJSP framework' },
  { value: 'No obligation', label: 'Initial consultation' },
];

const DEFAULT_TIPOS_RESPONSABILIDAD = [
  { titulo: 'Healthcare', descripcion: 'Errors in public hospitals and health centres, harmful waiting lists and delayed diagnoses.' },
  { titulo: 'Urban planning', descripcion: 'Damage arising from planning decisions, unlawful permits or municipal inaction.' },
  { titulo: 'Public highways', descripcion: 'Falls and accidents caused by defective pavements, roads, street lighting or inadequate signage.' },
  { titulo: 'Public services', descripcion: 'Abnormal functioning of services such as transport, waste collection or water supply.' },
  { titulo: 'Prisons', descripcion: 'Injuries, deaths or harm suffered by inmates under the custody of public authorities.' },
  { titulo: 'Education', descripcion: 'Accidents in state schools and negligence in the supervision of minors.' },
];

const DEFAULT_ORGANISMOS: { nombre: string; tipo: string; direccion: string }[] = [];

export default async function GovernmentLiabilityLocalPage({ params }: Props) {
  const content = await getServiceContentByServiceAndCity(SERVICE_KEY, params.city);
  if (!content) notFound();
  ...
  return (
    <>
      ...
      <ServiceSchema
        name={content.titleEn || `Government Liability Lawyers in ${cityName}`}
        ...
        <section className="bg-[#1a1a1a] relative overflow-hidden min-h-[75vh] md:min-h-[80vh] flex flex-col">
          <div className="absolute inset-0 opacity-25 z-0">
            <Image
              ...
              alt={`Government liability lawyers in ${cityName}`}
              fill
          ...
          <div className="container-custom relative z-[2] flex-1 flex items-center py-14 md:py-20">
            <div className="max-w-[720px] w-full">
              ...
              <p className="text-base md:text-lg text-neutral-300 leading-relaxed mb-8 md:mb-10 max-w-[580px]">
                {content.shortDescriptionEn || `Specialist lawyers in government liability claims in ${cityName}. We defend your rights against public authorities.`}
              </p>
          ...
          <div className="container-custom max-w-6xl">
            <div className="reveal">
              ...
              <h2 className="section-title mb-6">
                {content.titleEn || `Government liability lawyers in ${cityName}`}
              </h2>
              ...
              <div className="relative float-right ml-8 mb-6 w-full sm:w-[320px] lg:w-[380px]">
                <div className="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-xl">
                  <Image
                    src="/images/slides/garcia_valcarcel_caceres_abogados_slide_home_v2.webp"
                    alt={`Government liability lawyers ${cityName}`}
                    fill
                    className="object-cover"
          ...
          <section className="py-16 md:py-24 bg-neutral-50">
            <div className="container-custom max-w-6xl">
              <div className="reveal text-center mb-14">
                ...
                <h2 className="section-title mb-4">Types of government liability in {cityName}</h2>
              </div>
          ...
          <section className="py-16 md:py-24 bg-neutral-50">
            <div className="container-custom max-w-6xl">
              <div className="reveal text-center mb-14">
                ...
                <h2 className="section-title mb-4">Government liability in {cityName}: what you need to know</h2>
              </div>
            ...
            <div className="reveal flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              <div className="flex-1 text-center md:text-left">
                <h3 className="font-serif text-xl md:text-2xl font-semibold text-white mb-3">
                  Government liability claim deadlines in {cityName}
                </h3>
                <p className="text-sm text-neutral-300 leading-relaxed max-w-2xl">
                  The deadline to file a government liability claim is <strong className="text-white">1 year</strong> from
                  the date the damage occurred or its effects became known (<strong className="text-white">Law 40/2015 LRJSP</strong>).
                  If the authority rejects your claim, you may pursue an administrative-contentious appeal
                  before the relevant courts. Do not let the deadline pass.
                </p>
              </div>
          ...
          <section className="py-16 md:py-24 bg-neutral-50">
            <div className="container-custom max-w-6xl">
              <div className="reveal text-center mb-14">
                <div className="flex items-center gap-3 justify-center mb-4">
                  <span className="w-9 h-0.5 bg-brand-brown" />
                  <span className="text-[0.6rem] font-semibold text-brand-brown tracking-[0.2em] uppercase">Public bodies in {cityName}</span>
                  <span className="w-9 h-0.5 bg-brand-brown" />
                </div>
                <h2 className="section-title mb-4">Local public bodies in {cityName}</h2>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <div className="lg:col-span-2">
                  <div className="bg-brand-brown-hover text-white p-8 md:p-10 rounded-2xl sticky top-24">
                    ...
                    <h3 className="font-serif text-xl font-semibold mb-4">
                      Harmed by a public authority in {cityName}?
                    </h3>
          ...
          <section className="py-16 md:py-24 bg-white">
            <div className="container-custom max-w-4xl">
              <div className="reveal text-center mb-12">
                ...
                <h2 className="section-title mb-4">Frequently asked questions about government liability in {cityName}</h2>
              </div>
          ...
          <div className="container-custom max-w-4xl">
            <div className="reveal text-center">
              <p className="text-sm text-neutral-400 mb-4">
                Also visit our general government liability page for information
                on types of claims, deadlines and the full procedure.
              </p>
              <Link
              ...
              >
                View the general {SERVICE_NAME_EN} page <ArrowRight size={16} />
              </Link>
            </div>
          </div>
        </section>
          ...
          <div className="container-custom max-w-4xl relative z-10">
            <div className="reveal text-center">
              ...
              <h2 className="section-title-white mb-6">
                Government liability lawyers in {cityName}
              </h2>
