  ...
  return (
    <>
      ...
      <main>
        ...
        {/* Specialized Medical Malpractice Website */}
          ...
          <div className="container-custom max-w-4xl">
            <div className="reveal bg-white p-8 rounded-2xl text-center">
              ...
              <p className="text-sm text-neutral-500 leading-relaxed mb-6 max-w-2xl mx-auto">
                We have a dedicated website for medical malpractice with all the specialist content
              ...
              >
                Visit Medical Malpractice website →
              </a>
            </div>
          </div>
        </section>
