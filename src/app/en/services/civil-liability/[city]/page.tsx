...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = content.titleEn || `Civil Liability Lawyers in ${cityName} — GVC Lawyers`;
  const description = content.metaDescriptionEn || content.shortDescriptionEn ||
    `Specialist civil liability and insurance lawyers in ${cityName}. Damage claims, defence and maximum compensation. Over 55 years of experience. ☎ 968 241 025.`;
...
const DEFAULT_STATS = [
  ...
  { value: 'Art. 1902 CC', label: 'Civil Code' },
  { value: 'No obligation', label: 'Initial consultation' },
];

const DEFAULT_TIPOS_RESPONSABILIDAD = [
  { titulo: 'Contractual liability', descripcion: 'Breach of obligations agreed in civil and commercial contracts. Claims for resulting damages and losses.' },
  { titulo: 'Non-contractual liability', descripcion: 'Damages caused without a prior contractual relationship, governed by Art. 1902 of the Spanish Civil Code.' },
  { titulo: 'Professional liability', descripcion: 'Negligence by professionals (doctors, architects, lawyers) in the course of their practice.' },
  { titulo: 'Product liability', descripcion: 'Damages caused by defective products under the General Consumer Protection Act.' },
  { titulo: 'Neighbourhood liability', descripcion: 'Damages between adjoining properties: leaks, damp, nuisance and structural defects.' },
  { titulo: 'Homeowner associations', descripcion: 'Claims for damage to communal areas, construction defects and incidents within residential communities.' },
];

const DEFAULT_PLAZOS_PRESCRIPCION = [
  { tipo: 'Non-contractual', plazo: '1 year (Art. 1968.2 CC)', descripcion: 'From when the injured party becomes aware of the damage. Interrupted by extrajudicial or judicial claim.' },
  { tipo: 'Contractual', plazo: '5 years (Art. 1964 CC)', descripcion: 'General limitation period for personal actions with no special deadline. Applicable to most contractual breaches.' },
  { tipo: 'Defective products', plazo: '3 years (Art. 143 TRLGDCU)', descripcion: 'From when the injured party suffered the damage or became aware of the product defect.' },
  { tipo: 'Direct insurance action', plazo: '1 year (Art. 23 LCS)', descripcion: 'Direct action by the injured party against the liable party\'s insurer. From the date of the incident.' },
];

export default async function CivilLiabilityLocalPage({ params }: Props) {
  const content = await getServiceContentByServiceAndCity(SERVICE_KEY, params.city);
  if (!content) notFound();
  ...
  const breadcrumbs = [
    ...
    { name: SERVICE_NAME_EN, href: `/en/services/${FOLDER_SLUG_EN}` },
  ...
  return (
    <>
      ...
      <ServiceSchema
        name={content.titleEn || `Civil Liability Lawyers in ${cityName}`}
      ...
      <main>
        ...
        <section className="bg-[#1a1a1a] relative overflow-hidden min-h-[75vh] md:min-h-[80vh] flex flex-col">
          <div className="absolute inset-0 opacity-25 z-0">
            <Image
              ...
              alt={`Civil liability lawyers in ${cityName}`}
              fill
          ...
          <div className="container-custom relative z-[2] flex-1 flex items-center py-14 md:py-20">
            <div className="max-w-[720px] w-full">
              ...
              <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-bold text-white leading-[1.15] mb-5 md:mb-6">
                Civil{' '}
                <em className="italic text-brand-gold font-normal">liability lawyers</em>{' '}
                in {cityName}
              </h1>

              <p className="text-base md:text-lg text-neutral-300 leading-relaxed mb-8 md:mb-10 max-w-[580px]">
                {content.shortDescriptionEn || `Specialists in civil liability and insurance in ${cityName}. Damage claims, insurer defence and maximum compensation.`}
              </p>
          ...
          <div className="container-custom max-w-6xl">
            <div className="reveal">
              ...
              <h2 className="section-title mb-6">
                {content.titleEn || `Civil liability lawyers in ${cityName}`}
              </h2>
              ...
              <div className="relative float-right ml-8 mb-6 w-full sm:w-[320px] lg:w-[380px]">
                <div className="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-xl">
                  <Image
                    src="/images/slides/garcia_valcarcel_caceres_abogados_slide_home_v2.webp"
                    alt={`Civil liability lawyers ${cityName}`}
                    fill
                    className="object-cover"
          ...
          <section className="py-16 md:py-24 bg-neutral-50">
            <div className="container-custom max-w-6xl">
              <div className="reveal text-center mb-14">
                ...
                <h2 className="section-title mb-4">Types of civil liability in {cityName}</h2>
              </div>
          ...
          <section className="py-16 md:py-24 bg-neutral-50">
            <div className="container-custom max-w-6xl">
              <div className="reveal text-center mb-14">
                ...
                <h2 className="section-title mb-4">Civil liability in {cityName}: what you need to know</h2>
              </div>
            ...
            <div className="reveal flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              <div className="flex-1 text-center md:text-left">
                <h3 className="font-serif text-xl md:text-2xl font-semibold text-white mb-3">
                  Compensation concepts in {cityName}
                </h3>
                <p className="text-sm text-neutral-300 leading-relaxed max-w-2xl">
                  Civil liability compensation encompasses <strong className="text-white">consequential damage</strong> (actual
                  expenses incurred), <strong className="text-white">loss of earnings</strong> (income no longer received) and{' '}
                  <strong className="text-white">moral damage</strong> (suffering and personal harm). Under{' '}
                  <strong className="text-white">Art. 1106 of the Civil Code</strong>, redress must be full and complete.
                </p>
              </div>
          ...
          <section className="py-16 md:py-24 bg-neutral-50">
            <div className="container-custom max-w-6xl">
              <div className="reveal text-center mb-14">
                <div className="flex items-center gap-3 justify-center mb-4">
                  <span className="w-9 h-0.5 bg-brand-brown" />
                  <span className="text-[0.6rem] font-semibold text-brand-brown tracking-[0.2em] uppercase">Legal deadlines</span>
                  <span className="w-9 h-0.5 bg-brand-brown" />
                </div>
                <h2 className="section-title mb-4">Limitation periods for civil liability claims</h2>
              </div>
                ...
                <div className="lg:col-span-2">
                  <div className="bg-brand-brown-hover text-white p-8 md:p-10 rounded-2xl sticky top-24">
                    ...
                    <h3 className="font-serif text-xl font-semibold mb-4">
                      Need to claim damages in {cityName}?
                    </h3>
          ...
          <section className="py-16 md:py-24 bg-white">
            <div className="container-custom max-w-4xl">
              <div className="reveal text-center mb-12">
                ...
                <h2 className="section-title mb-4">Frequently asked questions about civil liability in {cityName}</h2>
              </div>
        ...
        {/* ═══════════════════════════════════════
            LINK TO GENERIC PAGE
        ═══════════════════════════════════════ */}
        <section className="py-12 md:py-16 bg-neutral-50 border-t border-neutral-200">
          <div className="container-custom max-w-4xl">
            <div className="reveal text-center">
              <p className="text-sm text-neutral-400 mb-4">
                Also visit our general civil liability page for information
                on types of claims, limitation periods and the full legal process.
              </p>
              <Link
              ...
              >
                View the general Civil Liability page <ArrowRight size={16} />
              </Link>
            </div>
          </div>
        </section>
          ...
          <div className="container-custom max-w-4xl relative z-10">
            <div className="reveal text-center">
              ...
              <h2 className="section-title-white mb-6">
                Civil liability lawyers in {cityName}
              </h2>
