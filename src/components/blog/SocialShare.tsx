...
export default function SocialShare({ url, title }: Props) {
  ...
  const shareLinks = {
    ...
    email: `mailto:?subject=${encodedTitle}&body=He%20encontrado%20este%20artículo%20interesante:%20${encodedUrl}`,
  };
    ...
    <div className="border-t border-b border-neutral-200 py-6 my-8">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-brand-dark">Compartir artículo:</span>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="p-2.5 rounded-sm bg-brand-dark text-white hover:bg-brand-dark2 transition-colors"
